...
function Jewelries() {
  return (
    <div className="Belts w-[100%] h-[210vh]   flex flex-col items-center justify-between   ">
      <div className="littleBelt w-[100%] h-[7.5vh]  flex items-center justify-center text-2xl ">
        <MdOutlineArrowBack /> Jewelries
      </div>
      <div className="w-[80%] h-[200vh]   flex flex-col items-center justify-around    ">
